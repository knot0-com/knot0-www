    ...
    <div className="min-h-screen bg-black text-white">
      ...
      <main className="pt-24 2xl:pt-32 pb-16 2xl:pb-24 px-6 md:px-12 lg:px-16 2xl:px-24">
        <div className="max-w-3xl 2xl:max-w-4xl mx-auto">
          <div className="mb-12">
            <h1 className="text-4xl 2xl:text-5xl font-bold text-white font-mono">
              Writing
            </h1>
          ...
          <div className="border border-black-border rounded-lg overflow-hidden">
            {posts.map((post, index) => (
              <Link
                ...
                className="group flex items-start gap-4 px-5 2xl:px-6 py-4 2xl:py-5 border-b border-black-border last:border-b-0 hover:bg-black-light/50 transition-colors"
              >
                <span className="text-white-muted font-mono text-sm pt-0.5 hidden sm:block w-6">
                  {String(posts.length - index).padStart(2, '0')}
                </span>
                <div className="flex-1 min-w-0">
                  <h2 className="text-white 2xl:text-lg group-hover:text-amber transition-colors font-mono font-medium truncate">
                    {post.title}
                  </h2>
                  {post.subtitle && (
      ...
      <footer className="py-6 2xl:py-8 px-6 md:px-12 lg:px-16 2xl:px-24 border-t border-black-border">
        <div className="max-w-3xl 2xl:max-w-4xl mx-auto flex items-center justify-between text-sm 2xl:text-base font-mono text-white-muted">
